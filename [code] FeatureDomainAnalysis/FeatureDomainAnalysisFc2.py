...
if __name__== "__main__":
    ...
    polarization_est_h= [35, 181, 343, 505, 666, 830]
    ...
    eol_H= np.where(np.array(data["Utot (V)"])< eol_TH)[0]
    eol_H= np.array([eol_H[0], 
                    #  eol_H[np.where(np.diff(eol_H)>= 30)[0][0]+ 1], 
                    #  eol_H[np.where(np.diff(eol_H)>= 30)[0][1]+ 1],
                     eol_H[np.where(np.diff(eol_H)>= 30)[0][2]+ 1],
                    #  eol_H[np.where(np.diff(eol_H)>= 30)[0][3]+ 1]
                    ]
                    )
    
    plt.figure(figsize= (6, 3))
    plt.plot(data["Time (h)"], data["Utot (V)"], color= "black", label= "Vtotal")
    for i in range(0, len(eol_H)):
        plt.scatter(data["Time (h)"].iloc[eol_H[i]], data["Utot (V)"].iloc[eol_H[i]], edgecolors= "black", color= "red", s= 30)
    plt.hlines(eol_TH, data["Time (h)"].iloc[0], data["Time (h)"].iloc[-1], label= "EOL TH (drop to 96%)", color= "darkred", ls= "--")
    plt.legend(loc= "best", fontsize= 15)
    plt.xticks(fontsize= 15)
    plt.yticks(fontsize= 15)
    ...
    scenario_1= y[: eol_H[0]]
    scenario_2= y[: eol_H[1]]
    
    ### (scenario 1) emd denoising for time series data
    lowess = sm.nonparametric.lowess
    transformation_curve= lowess(scenario_1, np.arange(1, len(scenario_1)+ 1), frac= 1.0/1.0, it= 0)[:, 1]
    ...
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], scenario_1[: eol_H[0]], color= "darkblue", label= "Vtotal")
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], transformation_curve, color= "darkgreen", label= "Smoothed Vtotal", lw= 2)
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], bacon_watts_curve, color= "darkred", label= "estimation of Bacon-Watts model", ls= "dotted", lw= 3, alpha= 0.5)
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], double_bacon_watts_curve, color= "darkred", label= "estimation of Bacon-Watts model", ls= "dashed", lw= 3, alpha= 0.5)
    plt.scatter(knee_onset_double_bacon_watts, scenario_1[knee_onset_double_bacon_watts], label= "knee onset (Double Bacon-Watts model)", edgecolors= "black", color= "darkred", s= 50, marker= "o")
    plt.scatter(knee_point, scenario_1[knee_point], label= "knee point (Bacon-Watts model)", edgecolors= "black", color= "black", s= 50, marker= "d")
    plt.scatter(data["Time (h)"].iloc[eol_H[0]], data["Utot (V)"].iloc[eol_H[0]], label= "EOL", edgecolors= "black", color= "darkblue", s= 50)
    plt.hlines(eol_TH, data["Time (h)"].iloc[0], data["Time (h)"].iloc[eol_H[0]], label= "EOL TH (drop to 96%)", color= "darkred", ls= "--")
    ...
    print("---------------------------------------------------------------------")
    print("(scenario 1) The optimal knee point locate at #", knee_point, "cycle")
    print("(scenario 1) The optimal knee onset locate at #", knee_onset, "cycle")
    print("(scenario 1) The optimal knee onset (double Bacon Watts) locate at #", knee_onset_double_bacon_watts, "cycle")

    ### (scenario 2) emd denoising for time series data
    lowess = sm.nonparametric.lowess
    transformation_curve= lowess(scenario_2[500: ], np.arange(1, len(scenario_2[500: ])+ 1), frac= 1.0/1.0, it= 0)[:, 1]
    ...
    plt.figure(figsize= (6, 4))
    plt.plot(data["Time (h)"].iloc[500: -1], y.iloc[500: -1], color= "darkblue", label= "Vtotal")
    plt.plot(data["Time (h)"].iloc[500: eol_H[1]], transformation_curve, color= "darkgreen", label= "Smoothed Vtotal", lw= 2)
    plt.plot(data["Time (h)"].iloc[500: eol_H[1]],  bacon_watts_curve, color= "darkred", label= "estimation of Bacon-Watts model", ls= "dotted", lw= 3, alpha= 0.5)
    plt.plot(data["Time (h)"].iloc[500: eol_H[1]], double_bacon_watts_curve, color= "darkred", label= "estimation of Bacon-Watts model", ls= "dashed", lw= 3, alpha= 0.5)
    plt.scatter(knee_onset_double_bacon_watts+ 500, scenario_2[knee_onset_double_bacon_watts+ 500], label= "knee onset (Double Bacon-Watts model)", edgecolors= "black", color= "darkred", s= 50, marker= "o")
    plt.scatter(knee_point+ 500, scenario_2[knee_point+ 500], label= "knee point (Bacon-Watts model)", edgecolors= "black", color= "black", s= 50, marker= "d")
    plt.scatter(data["Time (h)"].iloc[eol_H[1]], data["Utot (V)"].iloc[eol_H[1]], label= "EOL", edgecolors= "black", color= "darkblue", s= 50)
    plt.hlines(eol_TH, data["Time (h)"].iloc[0], data["Time (h)"].iloc[-1], label= "EOL TH (drop to 96%)", color= "darkred", ls= "--")
    plt.legend(loc= "best", fontsize= 8)
    plt.xticks(fontsize= 15)
    plt.yticks(fontsize= 15)
    plt.xlim(data["Time (h)"].iloc[500], data["Time (h)"].iloc[-1])
    plt.xlabel("Time (h)", fontsize= 15)
    plt.ylabel("V", fontsize= 15)
    plt.grid(True)
    plt.tight_layout()
    ...
    print("Selected features are: ", selected_features)
    print("---------------------------------------------------------------------")
    print("(scenario 2) The optimal knee point locate at #", knee_point+ 500, "cycle")
    print("(scenario 2) The optimal knee onset locate at #", knee_onset+ 500, "cycle")
    print("(scenario 2) The optimal knee onset (double Bacon Watts) locate at #", knee_onset_double_bacon_watts+ 500, "cycle")