...
if __name__== "__main__":
    ...
    plt.figure(figsize= (6, 3))
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], scenario_1, color= "darkblue", label= "Vtotal")
    plt.plot(data["Time (h)"].iloc[: eol_H[0]], transformation_curve, color= "darkgreen", label= "Smoothed Vtotal (EMD residual)")
    ...
    plt.scatter(knee_onset_double_bacon_watts, scenario_1[knee_onset_double_bacon_watts], label= "knee onset (double Bacon Watts)", color= "darkred", s= 50, marker= "o")
    plt.scatter(knee_point, scenario_1[knee_point], label= "knee point", color= "black", s= 50, marker= "d")
    ...
    plt.figure(figsize= (6, 3))
    plt.plot(data["Time (h)"].iloc[: eol_H[1]], scenario_2, color= "darkblue", label= "Vtotal")
    plt.plot(data["Time (h)"].iloc[500: eol_H[1]], transformation_curve, color= "darkgreen", label= "Smoothed Vtotal")
    plt.scatter(knee_point+ 500, transformation_curve[knee_point], label= "knee point", color= "black", s= 50, marker= "d")
    plt.scatter(knee_onset+ 500, transformation_curve[knee_onset], label= "knee onset", color= "darkgreen", s= 50, marker= "^")
    plt.scatter(knee_onset_double_bacon_watts+ 500, transformation_curve[knee_onset_double_bacon_watts], label= "knee onset (double Bacon Watts)", color= "darkred", s= 50, marker= "o")
    ...
    plt.figure(figsize= (6, 3))
    plt.plot(data["Time (h)"].iloc[: eol_H[1]], scenario_2[: eol_H[1]], color= "darkblue", label= "Vtotal")
    plt.scatter(knee_onset_double_bacon_watts+ 500, scenario_2[knee_onset_double_bacon_watts+ 500], label= "knee onset (double Bacon Watts)", color= "darkred", s= 50, marker= "o")
    plt.scatter(knee_point+ 500, scenario_2[knee_point+ 500], label= "knee point", color= "black", s= 50, marker= "d")
    plt.scatter(data["Time (h)"].iloc[eol_H[1]], data["Utot (V)"].iloc[eol_H[1]], label= "EOL", edgecolors= "black", color= "darkblue", s= 50)
    plt.hlines(eol_TH, data["Time (h)"].iloc[0], data["Time (h)"].iloc[eol_H[1]], label= "EOL TH (drop to 96%)", color= "darkred", ls= "--")
    plt.legend(loc= "best", fontsize= 10)
    plt.xticks(fontsize= 15)
    plt.yticks(fontsize= 15)
    plt.xlabel("Time (h)", fontsize= 15)
